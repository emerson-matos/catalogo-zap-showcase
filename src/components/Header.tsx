        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/flipbook">
              <Button
                variant="ghost"
                className="hover:text-primary transition-colors gap-2"
              >
        ...
        {isMenuOpen && (
          <div className="md:hidden border-t border-border/40 py-4">
            <nav className="flex flex-col space-y-4">
              ...
              <Link to="/flipbook" className="w-fit">
                <Button
                  variant="ghost"
                  className="text-left hover:text-primary transition-colors justify-start gap-2"
                >
                  <BookOpen className="h-4 w-4" />
                  Catálogo
                </Button>
