const DEFAULT_MESSAGE = "Olá! Tenho interesse em seus produtos. Poderia me enviar mais informações?";
...
export function createWhatsAppUrl(params?: { message?: string; numberOverride?: string }) {
